...
const appid = 'd4659d25640fa02de6562117fdedf357';
var searchBox = document.querySelector(".search-box");
var inputSearchEl = document.querySelector("#inputSearch");
var searchBtnEl = document.querySelector("#search-button");
var imgIconCurrenDay = document.querySelector("#icon-current-day");
var srchHisContEl = document.querySelector("#search-history");
var citiesUlEl = document.querySelector("#cities");
...
function getUVIndex(lat, lng) {
    $.ajax({
        ...
        beforeSend: function (request) {
            request.setRequestHeader('x-access-token', 'd4659d25640fa02de6562117fdedf357');
        },
