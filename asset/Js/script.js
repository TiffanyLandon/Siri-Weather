...
var cities = [];
var key = "d4659d25640fa02de6562117fdedf357";
...
function renderCities() {
  ...
  function getResponseWeather(cityName){
    var queryURL = "https://api.openweathermap.org/data/3.0/weather?q=" +cityName+ "&appid=" + key; 
    ...
    $.ajax({
      ...
      var CoordLat = response.coord.lat;
        ...
        var queryURL3 = "https://api.openweathermap.org/data/3.0/forecast?q=" + cityName + "&appid=" + key;
            $.ajax({
            url: queryURL3,
            method: "GET"
